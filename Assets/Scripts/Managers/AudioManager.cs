...
public class AudioManager : MonoBehaviour
{
    ...
    public void PlaySFX(int _sfxIndex, Transform _source)
    {
        ...
        if (_source != null && Vector2.Distance(PlayerManager.instance.transform.position, _source.position) >
            sfxMinimumDistance)
            return;
    ...
    public bool IsBgmPlaying(int index)
    {
        if (index >= 0 && index < bgm.Length)
            return bgm[index].isPlaying;
        return false;
    }
}

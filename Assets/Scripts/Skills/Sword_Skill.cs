...
public class Sword_Skill : Skill
{
    ...
    protected override void Start()
    {
        ...
        pierceUnlockButton.GetComponent<Button>().onClick.AddListener(UnlockPieceSword);
    ...
    {
        //To achieve your requirement let's adjust the code like this:
        Vector2 position = (Vector2)player.transform.position + new Vector2(
                AimDirection().normalized.x * launchForce.x,
                AimDirection().normalized.y * launchForce.y) * t + .5f * (Physics2D.gravity * swordGravity) 
                                                                       * (t * t);
        return position;
    }
    #endregion
